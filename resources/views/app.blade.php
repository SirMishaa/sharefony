...
@section('content')
    <div class="bg-gray-900 flex items-stretch bg-grey-lighter min-h-screen">
        <div
            class="mx-auto max-w-5xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40 w-full"
        >
                ...
                <div
                    ...
                    <ul class="my-4 space-y-3">
                        <li>
                            <a href="#"
                               class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                <svg class="h-4" viewBox="0 0 87.3 78" xmlns="http://www.w3.org/2000/svg">
                                    <path
                            ...
                            <a href="#"
                               class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                <svg class="h-3" xmlns="http://www.w3.org/2000/svg"
                                     ...
                                     viewBox="0 0 80 52">
                                    <defs>
                                        <linearGradient xlink:href="#a" id="b" x1="-108.903" x2="-1137.198"
                                                        y1="2124.834" y2="2110.651"
                        ...
                        <li>
                            <a href="#"
                               class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                <svg class="h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 43 40">
                                    <path
